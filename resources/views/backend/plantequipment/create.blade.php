...
@section('content')
    {{ Form::open(['route' => 'admin.plantEquipment.store', 'class' => 'form-horizontal', 'role' => 'form', 'method' => 'post', 'id' => 'create-permission', 'files' => true]) }}
        ...
        <div class="box box-info">
            ...
            <div class="box-body">
                <div class="form-group">
                    @include("backend.plantequipment.form")
                    <div class="edit-form-btn">
                    {{ link_to_route('admin.plantEquipment.index', trans('buttons.general.cancel'), [], ['class' => 'btn btn-danger btn-md']) }}
